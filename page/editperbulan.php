			...
			<td>
				<div class="col-md-4">
					<select id="bln" name="bln" class="form-control">
						<option></option>
						<option value="01" <?php if($_SESSION['bln']=="01"){echo "selected";}?>>Januari</option>
						<option value="02" <?php if($_SESSION['bln']=="02"){echo "selected";}?>>Februari</option>
						<option value="03" <?php if($_SESSION['bln']=="03"){echo "selected";}?>>Maret</option>
						<option value="04" <?php if($_SESSION['bln']=="04"){echo "selected";}?>>April</option>
						<option value="05" <?php if($_SESSION['bln']=="05"){echo "selected";}?>>Mei</option>
						<option value="06" <?php if($_SESSION['bln']=="06"){echo "selected";}?>>Juni</option>
						<option value="07" <?php if($_SESSION['bln']=="07"){echo "selected";}?>>Juli</option>
						<option value="08" <?php if($_SESSION['bln']=="08"){echo "selected";}?>>Agustus</option>
						<option value="09" <?php if($_SESSION['bln']=="09"){echo "selected";}?>>September</option>
						<option value="10" <?php if($_SESSION['bln']=="10"){echo "selected";}?>>Oktober</option>
						<option value="11" <?php if($_SESSION['bln']=="11"){echo "selected";}?>>November</option>
						<option value="12" <?php if($_SESSION['bln']=="12"){echo "selected";}?>>Desember</option>
					</select>
				</div>
				<div class="col-md-2">
